                        ...
                        <tfoot>
                            <tr class="cart-subtotal">
                                ...
                                <td><span class="amount">R$
                                    <?php echo htmlspecialchars( $cart["vlsubtotal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                            ...
                            <tr class="shipping">
                                ...
                                <td>
                                    R$
                                    <?php echo htmlspecialchars( $cart["vlfreight"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
                            ...
                            <tr class="order-total">
                                ...
                                <td><strong><span class="amount">R$
                                    <?php echo htmlspecialchars( $cart["vltotal"], ENT_COMPAT, 'UTF-8', FALSE ); ?>
