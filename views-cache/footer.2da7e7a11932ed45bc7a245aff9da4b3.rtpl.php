...
<!-- jQuery sticky menu -->
<script src="/lojahcode/res/site/js/owl.carousel.min.js"></script>
<script src="/lojahcode/res/site/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="/lojahcode/res/site/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="/lojahcode/res/site/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="/lojahcode//res/site/js/bxslider.min.js"></script>
<script type="text/javascript" src="/lojahcode//res/site/js/script.slider.js"></script>
</body>
</html>