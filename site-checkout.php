...
$app->get("/boleto/:idorder", function($idorder){
	...
	$order->get((int)$idorder);
		...
		$valor_cobrado = str_replace(",", ".", $valor_cobrado); // Formata o valor_cobrado.
		...
		$dadosboleto["endereco2"] = utf8_decode($order->getdescity())." ".utf8_decode($order->getdesstate())." ".$order->getdescountry()." ".$order->getdeszipcode();
